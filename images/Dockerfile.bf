...
RUN dnf install -y \
https://www.rpmfind.net/linux/centos/8-stream/BaseOS/$(uname -m)/os/Packages/libibverbs-32.0-4.el8.$(uname -m).rpm \
https://www.rpmfind.net/linux/centos/8-stream/BaseOS/$(uname -m)/os/Packages/rdma-core-32.0-4.el8.$(uname -m).rpm \
http://download.eng.bos.redhat.com/brewroot/vol/rhel-8/packages/openvswitch2.13/2.13.0/70.el8fdp/$(uname -m)/openvswitch2.13-2.13.0-70.el8fdp.$(uname -m).rpm \
http://download.eng.bos.redhat.com/brewroot/vol/rhel-8/packages/openvswitch2.13/2.13.0/70.el8fdp/$(uname -m)/openvswitch2.13-devel-2.13.0-70.el8fdp.$(uname -m).rpm \
http://download.eng.bos.redhat.com/brewroot/vol/rhel-8/packages/openvswitch2.13/2.13.0/70.el8fdp/$(uname -m)/python3-openvswitch2.13-2.13.0-70.el8fdp.$(uname -m).rpm \
...
http://download.eng.bos.redhat.com/brewroot/vol/rhel-8/packages/ovn2.13/20.09.0/12.el8fdp/$(uname -m)/ovn2.13-20.09.0-12.el8fdp.$(uname -m).rpm \
http://download.eng.bos.redhat.com/brewroot/vol/rhel-8/packages/ovn2.13/20.09.0/12.el8fdp/$(uname -m)/ovn2.13-central-20.09.0-12.el8fdp.$(uname -m).rpm \
http://download.eng.bos.redhat.com/brewroot/vol/rhel-8/packages/ovn2.13/20.09.0/12.el8fdp/$(uname -m)/ovn2.13-host-20.09.0-12.el8fdp.$(uname -m).rpm \
http://download.eng.bos.redhat.com/brewroot/vol/rhel-8/packages/ovn2.13/20.09.0/12.el8fdp/$(uname -m)/ovn2.13-vtep-20.09.0-12.el8fdp.$(uname -m).rpm
...
COPY ovn-k8s-cni-smart-nic /usr/libexec/cni/ovn-k8s-cni-smart-nic
